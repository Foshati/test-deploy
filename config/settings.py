...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-5921i*xlb6_&$%_easmed_0^@+3s@)mvs*#b8^-e7$hkglxrgy')
...
if DATABASE_URL:  # اگر URL دیتابیس خارجی تنظیم شده باشد
    DATABASES = {
        'default': dj_database_url.config(default=DATABASE_URL)
    }
else:  # در غیر این صورت از SQLite استفاده می‌شود
    DATABASES = {
        'default': {
